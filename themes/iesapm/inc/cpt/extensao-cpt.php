<?php
/*
* Custon post cursos extensão.
*/

// post type
function extensao_cpt(){

    $labels = array(
		'name'                  => _x( 'Cursos de Extensão', '', '' ),
		'singular_name'         => _x( 'Curso de Extensão', '', '' ),
		'menu_name'             => __( 'Extensão', '' ),
    ...
    $args = array(
        ...
        'rewrite'               => array( 'slug' => 'extensao' ), // my custom slug
	);
	register_post_type( 'extensao', $args );
}
add_action( 'init', 'extensao_cpt', 0 );

// Taxonomy
function register_extensao_taxonomy() {
    $labels = array(
    ...
    $args = array(
        ...
        'show_in_nav_menus' => true,
        'show_tagcloud' => true,
		'rewrite' => array('slug' => 'modalidade-extensao')
    );
    register_taxonomy( 'modalidade_extensao', 'extensao', $args );
}
add_action( 'init', 'register_extensao_taxonomy', 0 );
