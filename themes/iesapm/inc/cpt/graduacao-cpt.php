<?php
/*
* Custon post cursos graduação.
*/

// post type
function graduacao_cpt(){

    $labels = array(
		'name'                  => _x( 'Cursos de Graduação', '', '' ),
		'singular_name'         => _x( 'Curso de Graduação', '', '' ),
		'menu_name'             => __( 'Graduação', '' ),
    ...
    $args = array(
        ...
        'rewrite'               => array( 'slug' => 'graduacao' ), // my custom slug
	);
	register_post_type( 'graduacao', $args );
}
add_action( 'init', 'graduacao_cpt', 0 );


// Taxonomy
function register_graduacao_taxonomy() {
    $labels = array(
    ...
    $args = array(
        ...
        'show_in_nav_menus' => true,
        'show_tagcloud' => true,
		'rewrite' => array('slug' => 'modalidade-graduacao')
    );
    register_taxonomy( 'modalidade_graduacao', 'graduacao', $args );
}
add_action( 'init', 'register_graduacao_taxonomy', 0 );
